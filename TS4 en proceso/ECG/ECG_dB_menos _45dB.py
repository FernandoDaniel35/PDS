...
*** CÓDIGO FINAL ESTABLE: Umbral de BW en -45 dB RELATIVOS AL PICO y clave 'ecg_lead' corregida. ***
"""
...
# *** CLAVE CORREGIDA ***: La señal completa del ECG es 'ecg_lead' según el error reportado.
SIGNAL_KEY = 'ecg_lead' 
...
# ----------------------------
# Función para calcular ancho de banda (UMBRAL -45 dB RELATIVOS)
# ----------------------------
def bandwidth_dB(f, Pxx_dB, threshold_rel_dB=-45.0):
    """
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/1_ECG_Tiempo_M45.png', dpi=300)
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('resultados/2_Espectro_ECG_FFT_dB_M45.png', dpi=300)
plt.show()
plt.close()
...
# =========================================================================
UMBRAL_dB = -45.0 # Umbral fijo: -45 dB
...
plt.xlim(0, 100)
plt.tight_layout()
plt.savefig('resultados/3_Estimador_Periodograma_dB_M45.png', dpi=300)
plt.show()
plt.close()
...
plt.xlim(0, 100)
plt.tight_layout()
plt.savefig('resultados/4_Estimador_Welch_dB_M45.png', dpi=300)
plt.show()
plt.close()
...
plt.xlim(0, 100)
plt.tight_layout()
plt.savefig('resultados/5_Estimador_BlackmanTukey_dB_M45.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/6_BW_Periodograma_dB_M45.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/7_BW_Welch_dB_M45.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/8_BW_BlackmanTukey_dB_M45.png', dpi=300)
plt.show()
plt.close()
...
plt.xlim(0, 100)
plt.tight_layout()
plt.savefig('resultados/9_Comparacion_PSD_dB_M45.png', dpi=300)
plt.show()
plt.close()
