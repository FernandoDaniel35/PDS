...
*** CÓDIGO FINAL ESTABLE: Umbral de BW en -15 dB RELATIVOS AL PICO y clave 'ecg_lead' corregida. ***
"""
...
# ----------------------------
# Función para calcular ancho de banda (UMBRAL -15 dB RELATIVOS)
# ----------------------------
def bandwidth_dB(f, Pxx_dB, threshold_rel_dB=-15.0): # <-- MODIFICACIÓN A -15.0 dB
    """
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/1_ECG_Tiempo_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.tight_layout()
plt.savefig('resultados/2_Espectro_ECG_FFT_dB_M15.png', dpi=300)
plt.show()
plt.close()
