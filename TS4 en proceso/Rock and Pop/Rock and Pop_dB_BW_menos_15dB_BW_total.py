...
*** CÓDIGO FINAL MODIFICADO: CRITERIO DE ANCHO DE BANDA CAMBIADO A -15 dB RELATIVOS AL PICO ***
...
# ----------------------------
# Función para calcular ancho de banda (MODIFICADA A -15 dB RELATIVOS y 2xBW)
# ----------------------------
def bandwidth_total(f_MHz, Pxx_dB, threshold_rel_dB=-15.0): # <-- MODIFICACIÓN A -15.0 dB
    """
    ...
    threshold_rel_dB: Umbral fijo en dB relativo al pico (e.g., -15.0).
    """
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/1_Espectro_RF_Entrada_Lineal_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/2_Espectro_RF_Entrada_dB_M15.png', dpi=300)
plt.show()
plt.close()
...
# =========================================================================
UMBRAL_dB = -15.0 # Umbral fijo: -15 dB
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/3_Estimador_Periodograma_dB_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/4_Estimador_Welch_dB_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/5_Estimador_BlackmanTukey_dB_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/6_BW_Periodograma_dB_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/7_BW_Welch_dB_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/8_BW_BlackmanTukey_dB_M15.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/9_Comparacion_PSD_dB_M15.png', dpi=300)
plt.show()
plt.close()
