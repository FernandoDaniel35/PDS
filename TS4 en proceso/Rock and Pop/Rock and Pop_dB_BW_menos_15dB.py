...
- El umbral para BW en los estimadores DEP ahora es: (Pico Máximo en dB) - 15 dB.
"""
...
# ----------------------------
# Función para calcular ancho de banda (MODIFICADA A -15 dB RELATIVOS)
# ----------------------------
def bandwidth(f, Pxx_dB, threshold_rel_dB=-15.0):
    """
...
# =========================================================================
UMBRAL_dB = -15.0 # Nuevo umbral fijo: -15 dB
