...
- El umbral para BW en los estimadores DEP ahora es: (Pico Máximo en dB) - 20 dB.
"""
...
# ----------------------------
# Función para calcular ancho de banda (MODIFICADA A -20 dB RELATIVOS)
# ----------------------------
def bandwidth(f, Pxx_dB, threshold_rel_dB=-20.0):
    """
...
# =========================================================================
UMBRAL_dB = -20.0 # Nuevo umbral fijo: -20 dB
