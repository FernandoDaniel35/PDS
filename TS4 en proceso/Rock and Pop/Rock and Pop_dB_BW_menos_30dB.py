...
*** CÓDIGO FINAL MODIFICADO: CRITERIO DE ANCHO DE BANDA CAMBIADO A -30 dB RELATIVOS AL PICO ***
- Se mantiene el Gráfico 2 (Magnitud en dB).
- El umbral para BW en los estimadores DEP ahora es: (Pico Máximo en dB) - 30 dB.
"""
...
# ----------------------------
# Función para calcular ancho de banda (MODIFICADA A -30 dB RELATIVOS)
# ----------------------------
def bandwidth(f, Pxx_dB, threshold_rel_dB=-30.0):
    """
...
# =========================================================================
UMBRAL_dB = -30.0 # Nuevo umbral fijo: -30 dB
