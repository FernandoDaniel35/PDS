...
*** CÓDIGO FINAL MODIFICADO: CRITERIO DE ANCHO DE BANDA CAMBIADO A -10 dB RELATIVOS AL PICO ***
- Se mantiene el Gráfico 2 (Magnitud en dB).
- El umbral para BW en los estimadores DEP ahora es: (Pico Máximo en dB) - 10 dB.
"""
...
# ----------------------------
# Función para calcular ancho de banda (MODIFICADA A -10 dB RELATIVOS)
# ----------------------------
def bandwidth(f, Pxx_dB, threshold_rel_dB=-10.0):
    """
...
# =========================================================================
UMBRAL_dB = -10.0 # Nuevo umbral fijo: -10 dB
