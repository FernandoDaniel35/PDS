...
# -*- coding: utf-8 -*-
""" 
Densidad Espectral de Potencia del archivo de audio 'prueba_psd.wav' completo.
Incluye análisis mediante:
- Periodograma ventaneado
- Welch
- Blackman-Tukey
Todos los comentarios y resultados están adaptados al análisis del archivo de audio de prueba.
"""
...
# ----------------------------
# Cargar archivo WAV (prueba_psd.wav)
# ----------------------------
wav_file = 'prueba psd.wav'  # archivo de audio base
...
N = len(audio_signal)
print(f"Se usarán todas las {N} muestras del archivo de audio para el análisis")
...
def bandwidth(f, Pxx, threshold=0.05):
    """Devuelve la frecuencia mínima, máxima y ancho de banda donde el PSD supera un umbral relativo."""
...
# ----------------------------
# 0) Señal de audio en el tiempo
# ----------------------------
plt.figure(figsize=(10, 4))
plt.plot(np.arange(N) / fs, audio_signal, color='blue')
plt.title("Señal de Audio en el tiempo ('prueba_psd.wav')")
plt.xlabel("Tiempo [s]")
plt.ylabel("Amplitud")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/Audio_tiempo_prueba_psd.png', dpi=300)
plt.show()
plt.close()

# ----------------------------
# FFT del archivo de audio
# ----------------------------
...
plt.title("FFT del archivo de audio 'prueba_psd.wav'")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Magnitud")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/FFT_prueba_psd.png', dpi=300)
plt.show()
plt.close()
...
plt.title("Densidad Espectral de Potencia - Periodograma Ventaneado (Hamming) - prueba_psd.wav")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/Densidad_Espectral_de_Potencia_Periodograma_prueba_psd.png', dpi=300)
plt.show()
plt.close()

plt.figure(figsize=(10, 5))
plt.plot(f_per[mask_per], Pxx_per[mask_per], color='orange')
plt.title("Ancho de banda - Periodograma (prueba_psd.wav)")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/AnchoBanda_Periodograma_prueba_psd.png', dpi=300)
plt.show()
plt.close()
...
plt.title("Densidad Espectral de Potencia - Welch - prueba_psd.wav")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/Densidad_Espectral_de_Potencia_Welch_prueba_psd.png', dpi=300)
plt.show()
plt.close()

plt.figure(figsize=(10, 5))
plt.plot(f_welch[mask_w], Pxx_welch[mask_w], color='orange')
plt.title("Ancho de banda - Welch (prueba_psd.wav)")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/AnchoBanda_Welch_prueba_psd.png', dpi=300)
plt.show()
plt.close()
...
plt.title("Densidad Espectral de Potencia - Blackman-Tukey - prueba_psd.wav")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/Densidad_Espectral_de_Potencia_BlackmanTukey_prueba_psd.png', dpi=300)
plt.show()
plt.close()

plt.figure(figsize=(10, 5))
plt.plot(f_bt[mask_bt], Pxx_bt[mask_bt], color='orange')
plt.title("Ancho de banda - Blackman-Tukey (prueba_psd.wav)")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/AnchoBanda_BlackmanTukey_prueba_psd.png', dpi=300)
plt.show()
plt.close()
...
print("\nResultados del ancho de banda estimado para 'prueba_psd.wav':\n")
print(tabla_bw)
tabla_bw.to_csv('resultados/AnchoBanda_prueba_psd.csv', index=False, float_format='%.3f')
print("\n✅ Tabla guardada en 'resultados/AnchoBanda_prueba_psd.csv'")
