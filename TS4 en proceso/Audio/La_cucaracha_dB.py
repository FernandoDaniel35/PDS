...
# -*- coding: utf-8 -*-
""" 
Densidad Espectral de Potencia de un archivo de audio WAV completo - TODOS LOS GRÁFICOS SEPARADOS E INDIVIDUALES.
...
# Cargar archivo WAV
# ----------------------------
wav_file = 'la cucaracha.wav'  # archivo de audio
try:
...
print(f"Se usarán todas las {N} muestras del audio para el análisis")
...
plt.title("1. Señal de Audio ('la cucaracha.wav') en el Dominio del Tiempo")
plt.xlabel("Tiempo [s]")
plt.ylabel("Amplitud (Bins de cuantificación)")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/1_Señal_Cucaracha_Tiempo.png', dpi=300)
plt.show()
plt.close()
...
plt.title("2. Espectro de Magnitud (FFT) de 'la cucaracha.wav'")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Magnitud (Lineal)")
plt.xlim(0, fs/2) 
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/2_FFT_Cucaracha_Magnitud.png', dpi=300)
plt.show()
plt.close()
...
plt.title("3. Estimador de DEP - Periodograma (dB) - 'la cucaracha.wav'")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/3_Estimador_Periodograma_Cucaracha_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.title("4. Estimador de DEP - Welch (dB) - 'la cucaracha.wav'")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/4_Estimador_Welch_Cucaracha_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.title("5. Estimador de DEP - Blackman-Tukey (dB) - 'la cucaracha.wav'")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/5_Estimador_BlackmanTukey_Cucaracha_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/6_BW_Periodograma_Cucaracha_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/7_BW_Welch_Cucaracha_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/8_BW_BlackmanTukey_Cucaracha_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.title("9. Comparación de Estimadores de DEP (dB) - 'la cucaracha.wav'")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/9_Comparacion_PSD_Cucaracha_dB.png', dpi=300)
plt.show()
plt.close()
