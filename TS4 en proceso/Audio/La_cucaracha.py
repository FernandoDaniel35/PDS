...
# -*- coding: utf-8 -*-
""" 
Densidad Espectral de Potencia de un archivo de audio WAV completo.
Incluye análisis mediante:
- Periodograma ventaneado
- Welch
- Blackman-Tukey
Todos los comentarios y resultados están adaptados a señales de audio.
"""
...
# ----------------------------
# Función para calcular ancho de banda (sin cambios)
# ----------------------------
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/Audio_original_tiempo.png', dpi=300)
plt.show()
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/FFT_Audio.png', dpi=300)
plt.show()
plt.close()
...
print("\nResultados del ancho de banda estimado para el audio:\n")
print(tabla_bw)
tabla_bw.to_csv('resultados/ancho_de_banda_Densidad_Espectral_de_Potencia_audio_completo.csv', index=False, float_format='%.3f')
print("\n✅ Tabla guardada en 'resultados/ancho_de_banda_Densidad_Espectral_de_Potencia_audio_completo.csv'")
