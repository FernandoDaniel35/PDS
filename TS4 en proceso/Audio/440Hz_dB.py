...
# -*- coding: utf-8 -*-
""" 
Densidad Espectral de Potencia del archivo de audio '440Hz.wav' completo.
Incluye análisis mediante:
- Periodograma ventaneado
- Welch
- Blackman-Tukey
Todos los comentarios y resultados están adaptados al análisis de un 440Hz grabado.
...
plt.title("0. Señal de 440Hz en el tiempo")
plt.xlabel("Tiempo [s]")
plt.ylabel("Amplitud")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/0_440Hz_tiempo.png', dpi=300)
plt.show()
plt.close()

# ----------------------------
# 1) FFT del 440Hz (en dB)
# ----------------------------
...
plt.title("1. FFT del 440Hz (dB)")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Magnitud [dB]")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/1_FFT_440Hz_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.title("2. Densidad Espectral de Potencia - Periodograma Ventaneado (Hamming) - 440Hz (dB)")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/2_DEP_Periodograma_440Hz_dB.png', dpi=300)
plt.show()
plt.close()

plt.figure(figsize=(10, 5))
plt.plot(f_per[mask_per], Pxx_per_dB[mask_per], color='orange')
plt.title(f"3. Ancho de banda - Periodograma (440Hz): {BW_per:.2f} Hz")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/3_AnchoBanda_Periodograma_440Hz_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.title("4. Densidad Espectral de Potencia - Welch - 440Hz (dB)")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/4_DEP_Welch_440Hz_dB.png', dpi=300)
plt.show()
plt.close()

plt.figure(figsize=(10, 5))
plt.plot(f_welch[mask_w], Pxx_welch_dB[mask_w], color='orange')
plt.title(f"5. Ancho de banda - Welch (440Hz): {BW_w:.2f} Hz")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/5_AnchoBanda_Welch_440Hz_dB.png', dpi=300)
plt.show()
plt.close()
...
plt.title("6. Densidad Espectral de Potencia - Blackman-Tukey - 440Hz (dB)")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/6_DEP_BlackmanTukey_440Hz_dB.png', dpi=300)
plt.show()
plt.close()

plt.figure(figsize=(10, 5))
plt.plot(f_bt[mask_bt], Pxx_bt_dB[mask_bt], color='orange')
plt.title(f"7. Ancho de banda - Blackman-Tukey (440Hz): {BW_bt:.2f} Hz")
plt.xlabel("Frecuencia [Hz]")
plt.ylabel("Densidad espectral [dBV²/Hz]")
plt.grid(True)
plt.tight_layout()
plt.savefig('resultados/7_AnchoBanda_BlackmanTukey_440Hz_dB.png', dpi=300)
plt.show()
plt.close()
