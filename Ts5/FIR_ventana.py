...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 11 02:02:13 2025

@author: fer
"""
# -*- coding: utf-8 -*-
"""
Filtro_FIR_Ventana_Final.py - FIR (Método de Ventanas)
...
# 2. DISEÑO FIR VENTANA (Consigna c)
f_deseada = [0, ws0, wp[0], wp[1], ws1, fs / 2]; m_deseada = [0, 0, 1, 1, 0, 0]
...
# 3. EVALUACIÓN CONSOLIDADA (Consigna d) - Se compensa la demora FIR (ECG_f[... + demora])
...
for ii in regs_ruido:
    ...
    plt.plot(zoom_region, ECG_f[zoom_region + demora], label=f'3. ECG Filtrado (Ventana - τg={demora})', linewidth=2, color='blue')
